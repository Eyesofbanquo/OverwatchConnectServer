...
class MyApp<Sinatra::Base
	...
	post '/login' do
		...
		@lobby = Lobby.new(:username => params[:username], :password => params[:password], :udid => params[:udid], :region => params[:region])
	...
	post '/create-lobby' do
		...
		Lobby.first_or_create(:username => params[:username]).update(:platform => params[:platform], :groupsize => params[:groupSize],:region => params[:region], :groupid => SecureRandom.hex)
		#@lobby
#	post '/create-lobby' do
